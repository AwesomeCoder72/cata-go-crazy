...
void skillz_auton() {
  ...
  chassis.set_drive_pid(3, MID_DRIVE_SPEED);
  chassis.wait_drive();
  ...
  chassis.set_drive_pid(25, 20);
  chassis.wait_drive();

  chassis.set_drive_pid(-7, MID_DRIVE_SPEED);
  chassis.wait_drive();
  ...
  chassis.set_drive_pid(32, MID_DRIVE_SPEED);
  chassis.wait_drive();
